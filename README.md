...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕RUDRA▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕RUDRA▕┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
...
\033[1;91m☞ Auther     : DARKNET HaCkeR
\033[1;92m☞ WhatsApp   : 918455847226
\033[1;95m☞ YouTube    :  https://youtube.com/channel/UCCfGjnal1r8JTxQXfDVRRsA
...
def menu():
	...
	print (S + '[' + P + '☞3' + S + ']' + S + ' DARKNET HACKER WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num 918455847226✓')
	    psb('WelCome To DARKNET HaCkeR')
	    psb('Congratulations Hack_FB Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ DARKNET')
	    psb('🔓Password ☆ HACKER')
	    psb('Subscribe My Youtube Channel DARKNET HaCkeR')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/ Hack_FB && python2 Hack_FB.py')
	elif bm =='3':
	    os.system('xdg-open https://chat.whatsapp.com/DTwwVpHoSEYBFclsyONGM1')
	    menu()
	elif bm =='4':
